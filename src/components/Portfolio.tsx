...
const portfolio: Array<{ "title": string, shortTitle?: string, "category": string, "url": string, "image": string, "imgFit"?: string, "description": string }> = [
    {
        ...
        "description": "Mein Kollege Dr. Frank Köhne und ich waren zu Gast beim datenbusiness Podcast und haben über die viadee, LLMs, RAG und MLOps gesprochen.\n\nEin Videocast der Folge ist auf <a href='https://www.youtube.com/watch?v=Uz9YNGiN9pY'>Youtube</a> zu finden.\n\nFolgenbeschreibung:\n\nIT-Unternehmensberatung mit ganz besonderer Kultur.\nDie viadee steht seit 1994 für Unabhängigkeit, fachliches Know-how und Innovationsfreude. Mit mehr als 200 Mitarbeiter:innen an den Standorten in Münster, Köln und Dortmund berät die viadee namhafte Unternehmen aus unterschiedlichen Branchen in allen Phasen der Softwareentwicklung. Die Dienstleistungen reichen von der Entwicklung komplexer Anwendungssysteme über den Aufbau der IT-Architekturen bis zur Optimierung der Geschäftsprozesse, alles maßgeblich gesteuert durch Qualitäts- und Projektmanagement.\n\nIm heutigen Gespräch erfahren wir mehr über die viadee und unterhalten uns weiter über die fachlichen Themen rund um LLMs, RAG sowie MLOps."
    },
    {
